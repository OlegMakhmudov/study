...
public class QuickSort {
    ...
    public static void recursionFastSort(int[] array, int min, int max) {
        ...
        int i = min, j = max;
        while (i <= j) {  // относительно элемента middle определяем меньшие элементы слева, большие справа, т.е. мы сравниваем все элементы с со средним элементом и определяем их либо слева от середины, либо справа
